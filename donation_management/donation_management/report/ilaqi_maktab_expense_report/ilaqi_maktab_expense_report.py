...
def execute(filters=None):
    columns = [
        ...
        {'label': _('Expense Category'), 'fieldname': 'expense_category', 'fieldtype': 'Data', 'width': 150},
    ...
    data = frappe.get_all(
        'Maktab Expense',
        fields=['ilaqi_maktab','posting_date','expense_category','employee','expense_type','amount','journal_entry'],
